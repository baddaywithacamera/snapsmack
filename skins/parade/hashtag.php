<?php
/**
 * SNAPSMACK - PARADE Hashtag Archive
 * Alpha v0.7.9
 *
...
$hover_overlay = $settings['pa_hover_overlay']      ?? 'dark';
...
<div id="pa-app">
    ...
    <div class="pa-archive-header">
        <a href="<?php echo BASE_URL; ?>" class="pa-back-link">
    ...
    <!-- ── Grid ────────────────────────────────────────────────────────────── -->
    <main class="pa-grid" aria-label="<?php echo htmlspecialchars($tag_display); ?> photos">
