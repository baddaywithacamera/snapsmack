<?php
/**
 * SNAPSMACK - Game On Static Page Template
 *
 * Used by page.php when active skin is game-on.
...
<!-- ── Page content ─────────────────────────────────────────────────────── -->
<main class="go-static-content">

    <h1 class="go-static-title"><?php echo htmlspecialchars($page_data['title']); ?></h1>
    ...
    <div class="go-static-body description">
        <?php
