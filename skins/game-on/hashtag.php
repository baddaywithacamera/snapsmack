<?php
/**
 * SNAPSMACK - Game On Hashtag Archive
 * Alpha v0.7.9
 *
...
$hover_overlay = $settings['go_hover_overlay']      ?? 'dark';
...
<div id="go-app">
    ...
    <!-- ── Grid ────────────────────────────────────────────────────────────── -->
    <main class="go-grid" aria-label="<?php echo htmlspecialchars($tag_display); ?> photos">
...
<?php /* Hashtag infinite scroll moved to assets/js/ss-engine-tag-infinite.js
   (shared, prefix-derived; loaded via the skin manifest). The #go-sentinel
