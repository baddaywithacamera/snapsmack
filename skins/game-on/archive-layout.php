<?php
/**
 * SNAPSMACK - Game On Archive Layout
 * Alpha v0.7.9
 *
...
<!-- ── Archive Header ──────────────────────────────────────────────────── -->
<div class="go-archive-header">
    <h1 class="go-archive-title"><?php echo htmlspecialchars($archive_name ?? 'Archive'); ?></h1>
    <?php if (!empty($archive_desc)): ?>
        <p class="go-archive-meta"><?php echo htmlspecialchars($archive_desc); ?></p>
    <?php endif; ?>
    <?php if (!empty($total_images)): ?>
        <p class="go-archive-meta"><?php echo number_format($total_images); ?> post<?php echo $total_images !== 1 ? 's' : ''; ?></p>
    <?php endif; ?>
</div>
...
<main>
    ...
    // For Game On, look up each image's cover post_id to get post metadata,
