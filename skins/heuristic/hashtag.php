<?php
/**
 * SNAPSMACK - HEURISTIC Hashtag Archive
 * Alpha v0.7.9
 *
...
$hover_overlay = $settings['he_hover_overlay']      ?? 'dark';
...
<div id="he-app">
    ...
    <div class="he-archive-header">
        <a href="<?php echo BASE_URL; ?>" class="he-back-link">
    ...
    <!-- ── Grid ────────────────────────────────────────────────────────────── -->
    <main class="he-grid" aria-label="<?php echo htmlspecialchars($tag_display); ?> photos">
...
<?php /* Hashtag infinite scroll moved to assets/js/ss-engine-tag-infinite.js
   (shared, prefix-derived; loaded via the skin manifest). The #he-sentinel
