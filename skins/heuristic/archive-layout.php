<?php
/**
 * SNAPSMACK - HEURISTIC Archive Layout
 * Alpha v0.7.9
 *
...
?>
<div class="he-content-wrap">

<?php include __DIR__ . '/skin-profile.php'; ?>

<!-- ── Archive Header ──────────────────────────────────────────────────── -->
<div class="he-archive-header">
    <h1 class="he-archive-title"><?php echo htmlspecialchars($archive_name ?? 'Archive'); ?></h1>
    <?php if (!empty($archive_desc)): ?>
        <p class="he-archive-meta"><?php echo htmlspecialchars($archive_desc); ?></p>
    <?php endif; ?>
    <?php if (!empty($total_images)): ?>
        <p class="he-archive-meta"><?php echo number_format($total_images); ?> post<?php echo $total_images !== 1 ? 's' : ''; ?></p>
    <?php endif; ?>
</div>
...
<main>
    ...
    // For HEURISTIC, look up each image's cover post_id to get post metadata,
    ...
    <div class="he-grid">
        <?php $he_idx = 0; foreach ($tiles as $tile):
