<?php
/**
 * SNAPSMACK - HEURISTIC Skin Footer
 * Alpha v0.7.9
 *
...
?>
<!-- Post modal overlay (populated by he-modal.js). Rendered in the SHARED
...
<div id="he-modal-overlay" class="he-modal-overlay" hidden
     data-grid-url="<?php echo htmlspecialchars(BASE_URL); ?>"<?php echo !empty($he_autoopen) ? ' data-autoopen="1"' : ''; ?>>
    <div class="he-modal-backdrop"></div>
    <div id="he-modal-frame" class="he-modal-frame"></div>
</div>

<!-- Avatar lightbox (populated by he-lightbox.js). Shared by every Grid page. -->
<div id="he-lightbox" class="he-lightbox" hidden>
    <button type="button" class="he-lightbox-close" aria-label="Close">&times;</button>
    <img class="he-lightbox-img" src="" alt="Profile photo">
</div>
<?php
...
// All HEURISTIC engines load through the manifest above (require_scripts →
