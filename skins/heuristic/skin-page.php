<?php
/**
 * SNAPSMACK - HEURISTIC Static Page Template
 *
 * Used by page.php when active skin is heuristic.
...
<!-- ── Page content ─────────────────────────────────────────────────────── -->
<main class="he-static-content">

    <h1 class="he-static-title"><?php echo htmlspecialchars($page_data['title']); ?></h1>
    ...
    <div class="he-static-body description">
        <?php
