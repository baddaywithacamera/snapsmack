...
// ── Footer: background (colour+opacity, mirrors navbar) + gap above it ──────
$_jt_footer_gap = max(0, min(120, (int)($settings['jt_footer_gap'] ?? 40)));
$_jt_footer_op  = max(0, min(100, (int)($settings['jt_footer_opacity'] ?? 0)));
$_jt_footer_bg  = 'var(--panel-bg,transparent)';
if ($_jt_footer_op > 0) {
