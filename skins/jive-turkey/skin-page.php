<?php
/**
 * SNAPSMACK - JIVE TURKEY Static Page Template
 *
 * Used by page.php when active skin is jive-turkey.
...
<body class="jt-static-page">

<!-- #page-wrapper carries z-index:1 so the footer (included below, inside this
     wrapper) sits ABOVE the fixed jive-turkey canvas — matching blogroll.php, where
...
<!-- ── Page content ─────────────────────────────────────────────────────── -->
<main class="jt-static-content">

    <h1 class="jt-static-title"><?php echo htmlspecialchars($page_data['title']); ?></h1>
    ...
    <div class="jt-static-body description">
        <?php
