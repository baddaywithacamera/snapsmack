<?php
/**
 * SNAPSMACK - JIVE TURKEY Hashtag Archive
 * Alpha v0.7.9
 *
...
$hover_overlay = $settings['jt_hover_overlay']      ?? 'dark';
...
<div id="jt-app">
    ...
    <div class="jt-archive-header">
        <a href="<?php echo BASE_URL; ?>" class="jt-back-link">
    ...
    <!-- ── Grid ────────────────────────────────────────────────────────────── -->
    <main class="jt-grid" aria-label="<?php echo htmlspecialchars($tag_display); ?> photos">
...
<?php /* Hashtag infinite scroll moved to assets/js/ss-engine-tag-infinite.js
   (shared, prefix-derived; loaded via the skin manifest). The #jt-sentinel
