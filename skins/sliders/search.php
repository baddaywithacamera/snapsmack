<?php
/**
 * SNAPSMACK - SLIDERS Search Results
 *
 * Full-text search page for SLIDERS. $search_q is set by index.php's ?q=
 ...
 * skin-profile.php, exactly as on every other SLIDERS page.
 *
