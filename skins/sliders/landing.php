...
<main>
    <div class="tg-grid">
        ...
        <?php
            ...
            // SLIDERS deliberately keeps the ordinary GRAM square tile treatment.
            // The moving wall is the unusual part; foreground images remain normal.
            $thumb_src   = $post['img_thumb_square'] ?: ($post['img_thumb_aspect'] ?: $post['img_file']);
