...
return [
    'name'        => 'THE GRID',
    'version'     => '1.3.38', // restored 22 af1d58c5-stripped controls (Image Gap, Nav->Tiles Gap, Post Count Colour, Grid Bg/Gap Colour, Tile Radius, Title+Tagline font/size/weight/colour, Nav Case, Image/Page Bg, Primary/Secondary Text, Accent, Border, Body Font, Grid Max Width, Side Gutter) - all consumer-backed
