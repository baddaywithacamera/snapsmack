...
return [
    ...
    'options' => [
        ...
        'chap_archive_max_width' => [
            ...
            'max'      => '2400',
            'selector' => ':root',
            'property' => '--chap-archive-max-width',
            'unit'     => 'px',
        ],
        'chap_archive_gap' => [
            'section'  => 'ARCHIVE GRID',
