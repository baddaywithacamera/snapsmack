...
<div style="padding: 20px; max-width: 480px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 14px; color: #1A1A1A; line-height: 1.6;">

    <h2 style="font-size: 18px; font-weight: 700; margin: 0 0 16px;">Photogram</h2>

    <p>A phone-native photo blog that looks and feels like a classic photo-sharing app. Works on every device — desktop shows a centred phone column, mobile fills the screen.</p>

    <h3 style="font-size: 14px; font-weight: 700; margin: 20px 0 8px;">Using Photogram</h3>
    ...
    <p style="color: #8E8E8E; font-size: 13px;">Photogram — Alpha v0.7.3a</p>
</div>
