...
return [
    ...
    'options' => [
        ...
        'pg_column_width' => [
            ...
            'default' => 'phone',
            'options' => [
                'phone'     => ['label' => 'Phone Column (480px)', 'css' => '{ --pg-column-width: 480px; }'],
                'wide'      => ['label' => 'Wide (900px)',         'css' => '{ --pg-column-width: 900px; }'],
                'fullwidth' => ['label' => 'Full Width',          'css' => '{ --pg-column-width: 100%; }'],
            ],
            'selector' => ':root',
        ...
        'pg_grid_gutter' => [
            ...
            'default' => 'none',
            'options' => [
                'none'   => ['label' => 'None (edge to edge)', 'css' => '{ --pg-grid-gutter: 0px; }'],
                'small'  => ['label' => 'Small (16px)',        'css' => '{ --pg-grid-gutter: 16px; }'],
                'medium' => ['label' => 'Medium (32px)',       'css' => '{ --pg-grid-gutter: 32px; }'],
                'large'  => ['label' => 'Large (64px)',        'css' => '{ --pg-grid-gutter: 64px; }'],
            ],
            'selector' => ':root',
        ...
        'pg_grid_gap' => [
            ...
            'default' => 'none',
            'options' => [
                'none'     => ['label' => 'None',   'css' => '{ --pg-grid-gap: 0px; }'],
                'hairline' => ['label' => '1px',    'css' => '{ --pg-grid-gap: 1px; }'],
                'small'    => ['label' => '2px',    'css' => '{ --pg-grid-gap: 2px; }'],
                'medium'   => ['label' => '4px',    'css' => '{ --pg-grid-gap: 4px; }'],
                'large'    => ['label' => '8px',    'css' => '{ --pg-grid-gap: 8px; }'],
            ],
            'selector' => ':root',
        ...
        'pg_tile_aspect' => [
            ...
            'default' => 'square',
            'options' => [
                'square'     => ['label' => 'Square (1:1)',    'css' => '{ --pg-tile-aspect: 1 / 1; }'],
                'portrait45' => ['label' => 'Portrait (4:5)',  'css' => '{ --pg-tile-aspect: 4 / 5; }'],
                'portrait34' => ['label' => 'Portrait (3:4)',  'css' => '{ --pg-tile-aspect: 3 / 4; }'],
                'portrait23' => ['label' => 'Portrait (2:3)',  'css' => '{ --pg-tile-aspect: 2 / 3; }'],
                'land43'     => ['label' => 'Landscape (4:3)', 'css' => '{ --pg-tile-aspect: 4 / 3; }'],
                'land32'     => ['label' => 'Landscape (3:2)', 'css' => '{ --pg-tile-aspect: 3 / 2; }'],
                'wide169'    => ['label' => 'Wide (16:9)',     'css' => '{ --pg-tile-aspect: 16 / 9; }'],
                // Instant-film ratios — mirror INSTANT CAMERA's format map so a
                // mobile PHOTOGRAM companion shows the same uncropped prints.
                'polaroid'    => ['label' => 'Polaroid print (823:1000)',  'css' => '{ --pg-tile-aspect: 823 / 1000; }'],
                'go'          => ['label' => 'Polaroid Go (47:60)',        'css' => '{ --pg-tile-aspect: 47 / 60; }'],
                'instax_mini' => ['label' => 'Instax Mini (62:46)',        'css' => '{ --pg-tile-aspect: 62 / 46; }'],
                'instax_wide' => ['label' => 'Instax Wide (99:62)',        'css' => '{ --pg-tile-aspect: 99 / 62; }'],
            ],
            'selector' => ':root',
        ...
        'pg_tile_border_width' => [
            ...
            'default' => 'none',
            'options' => [
                'none'  => ['label' => 'None', 'css' => '{ --pg-tile-border-width: 0px; }'],
                'thin'  => ['label' => '1px',  'css' => '{ --pg-tile-border-width: 1px; }'],
                'thick' => ['label' => '2px',  'css' => '{ --pg-tile-border-width: 2px; }'],
            ],
            'selector' => ':root',
        ...
        'pg_avatar_shape' => [
            ...
            'default' => 'circle',
            'options' => [
                'circle'  => ['label' => 'Circle',          'css' => '{ --pg-avatar-radius: 50%; }'],
                'rounded' => ['label' => 'Rounded Square',  'css' => '{ --pg-avatar-radius: 12px; }'],
            ],
            'selector' => ':root',
        ...
        'pg_sheet_speed' => [
            ...
            'default' => 'normal',
            'options' => [
                'fast'   => ['label' => 'Fast (200ms)',   'css' => '{ --pg-sheet-speed: 200ms; }'],
                'normal' => ['label' => 'Normal (280ms)', 'css' => '{ --pg-sheet-speed: 280ms; }'],
                'slow'   => ['label' => 'Slow (400ms)',   'css' => '{ --pg-sheet-speed: 400ms; }'],
            ],
            'selector' => ':root',
