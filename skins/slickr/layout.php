...
<div id="scroll-stage" class="sl-single-flow">
    ...
    <!-- Navbar snapped to the bottom of the stage (INFO / COMMENTS / prev-next).
         Solo skin: info + comments are hidden drawers — 1 opens info, 2 opens
         comments — driven by core ss-engine-footer.js + smack-keyboard, same as
         50-shades. -->
    <div id="infobox">
        <?php include dirname(__DIR__, 2) . '/core/navigation-bar.php'; ?>
    </div>

    <!-- Hidden drawer panes (core footer engine toggles these via the navbar
         INFO/COMMENTS buttons and keys 1/2; #footer starts display:none). -->
    <div id="footer">
        <div id="pane-info" class="footer-pane sl-pane">
            <div class="sl-pane-inner">
        ...
        <div id="pane-comments" class="footer-pane sl-pane">
            <div class="sl-pane-inner">
                ...
                <?php else: ?>
                    <p class="sl-comments-closed">Comments are closed on this photograph.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
