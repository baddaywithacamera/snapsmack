/**
 * SNAPSMACK - AURORA Sticky Nav
 *
 * Watches the profile header via IntersectionObserver.
 * Adds .profile-hidden to .au-sticky-nav when the profile
...
(function () {
    ...
    function initStickyNav() {
        var profile  = document.querySelector('.au-profile');
        var nav      = document.querySelector('.au-sticky-nav');
