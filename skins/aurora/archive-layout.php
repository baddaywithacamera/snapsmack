<?php
/**
 * SNAPSMACK - AURORA Archive Layout
 * Alpha v0.7.9
 *
...
<!-- ── Archive Header ──────────────────────────────────────────────────── -->
<div class="au-archive-header">
    <h1 class="au-archive-title"><?php echo htmlspecialchars($archive_name ?? 'Archive'); ?></h1>
    <?php if (!empty($archive_desc)): ?>
        <p class="au-archive-meta"><?php echo htmlspecialchars($archive_desc); ?></p>
    <?php endif; ?>
    <?php if (!empty($total_images)): ?>
        <p class="au-archive-meta"><?php echo number_format($total_images); ?> post<?php echo $total_images !== 1 ? 's' : ''; ?></p>
    <?php endif; ?>
</div>
...
<main>
    ...
    // For AURORA, look up each image's cover post_id to get post metadata,
    ...
    <div class="au-grid">
        <?php $au_idx = 0; foreach ($tiles as $tile):
