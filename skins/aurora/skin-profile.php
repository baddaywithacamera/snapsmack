...
$_au_navbar_op_landing = max(0, min(100, (int)($settings['au_navbar_opacity'] ?? 0)));
$_au_navbar_op_inner   = ($settings['au_navbar_opacity_inner'] ?? '') !== ''
    ? max(0, min(100, (int)$settings['au_navbar_opacity_inner']))
    : $_au_navbar_op_landing;
$_au_navbar_op  = $_au_on_home ? $_au_navbar_op_landing : $_au_navbar_op_inner;
...
<style id="au-vars">:root{--tile-bw:<?php echo $_au_bw; ?>px;--tile-radius:<?php echo $_au_radius; ?>px;--ring-op:<?php echo $_au_bo; ?>;--au-sky:<?php echo htmlspecialchars($_au_sky); ?>;--profile-text-glow:<?php echo htmlspecialchars($_au_glow_css); ?>;--nav-line-opacity:<?php echo $_au_nav_line_op; ?>;--nav-text-glow:<?php echo htmlspecialchars($_au_navglow_css); ?>;--nav-text-glow-strong:<?php echo htmlspecialchars($_au_navglow_strong); ?>;--panel-bg:<?php echo htmlspecialchars($_au_panel_bg); ?>;--panel-extend:<?php echo (int)$_au_panel_extend; ?>px;--au-navbar-bg:<?php echo htmlspecialchars($_au_navbar_bg); ?>;--posts-glow:<?php echo htmlspecialchars($_au_posts_glow); ?>;--post-count-color:<?php echo htmlspecialchars($settings['au_posts_color'] ?? '#8a8a8a'); ?>;--au-navline-shadow:<?php echo htmlspecialchars($_au_navline_shadow); ?>;--nav-line-green:<?php echo $_au_nav_line_green; ?>;--nav-line-underline-display:<?php echo $_au_nav_underline; ?>;}</style>
