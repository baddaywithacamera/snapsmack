...
**Remediation release:** SnapSmack 0.7.573  
...
Release 0.7.573 closes that boundary. Publisher fields are now reduced to inert,
...
**Affected code:** pre-0.7.573 `snapsmack_generate_llms()`
...
The source remediation is complete in 0.7.573. It preserves useful discovery,
