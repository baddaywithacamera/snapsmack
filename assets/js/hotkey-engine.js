 ...
 * Version: 3.0 - Ground Up Rebuild
 * MASTER DIRECTIVE: Full file return. Logic only. Uses hotkey-engine.css.
 * Keys: H = help, X = close, 1 = info, 2 = comments, arrows = navigate
 */
...
function toggleHelpModal() {
    ...
    const commentRow = commentsEnabled
        ? `<li><strong>[ 2 ]</strong><span>Toggle Comms</span></li>` : '';
