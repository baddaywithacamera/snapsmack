...
<div class="main">
    ...
    <div class="dash-grid mt-30">
        ...
        <div class="box">
            ...
            <?php endif; ?>
            <?php
            // FEDIVERSE federation — this blog's own fediverse reach.
            ...
            ?>
                ...
                <a href="smack-fediverse-portal.php"><button class="btn-smack master-update-btn mt-25">MANAGE FEDERATION</button></a>
            <?php endif; ?>
        </div>
    </div>
