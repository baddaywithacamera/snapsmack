...
$faq_qas = <<<'HTML'
            ...
            <div class="qa" id="q-install-modes">
                ...
                <p>SnapSmack ships in four install personalities — SMACKONEOUT (single-user photoblog), GRAMOFSMACK (a faithful 2016-Instagram-clone with three-across grids and carousel posts up to ten images deep), SMACKTALK (essays and pages alongside the photoblog), and SMACKTHEMOUT (Picasa-style public albums for friends and family, managed from SNAP SLAPPER, no fediverse). You pick one when you install. You don't switch later.</p>
