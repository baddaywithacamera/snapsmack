    ...
    <section class="posts">
        <div class="wrap">
            ...
            <article class="post" id="feds-at-door">
                ...
                <p>Here's the surprise: it barely costs you anything to run. SMACKVERSE is just HTTP going back and forth — signed messages out, signed messages in — so it doesn't stress the box or demand a beefy server. No heavy daemon, no queue chewing your CPU, no reason it can't live on the same ordinary hosting your photoblog already sits on. SMACKVERSE makes the old new again, without making your server sweat.</p>
