    ...
    <section class="posts">
        <div class="wrap">
            ...
            <article class="post" id="skin-js-scanner">
                ...
                <p>There's a site-level toggle: <strong>Allow Custom Skin JS</strong>. On by default, because most users haven't had their skin files tampered with and don't need a daily alarm. Turn it off and the scanner treats any of the above patterns as a violation regardless of whether they look benign — useful for sites where nothing should ever be in a skin that the original package didn't put there.</p>
