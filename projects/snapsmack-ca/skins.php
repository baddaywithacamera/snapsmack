...
$skins = [
    ...
    ['Parade', ['parade-landing.png', 'parade-archive.png', 'parade-page.png'], 'allinthewrist.photoblogs.fyi', 'https://allinthewrist.photoblogs.fyi', 'An LGBT+ identity skin that flies Rainbow, Progress Pride, Trans, Bisexual, Non-Binary, Pansexual, Lesbian, Asexual, Aromantic, Genderfluid, Genderqueer, or Two-Spirit colours behind a classic three-across feed. The full-screen flag waves, coordinated borders move across the tiles, and reduced-motion visitors receive a still version.', 'GRAMOFSMACK (2.0)', 'Three-column identity grid / carousel archive'],
    ['GAME ON', ['gameon-landing.png', 'gameon-solo.png', 'gameon-page.png'], 'theschoolofhardnocks.ca', 'https://theschoolofhardnocks.ca', 'Every photograph on the site is also a sliding puzzle. Behind the three-across feed, a field of 144 live fifteen-puzzles shuffles itself and quietly solves itself while you read. Click any one and it fills the screen: rebuild the photograph tile by tile, on a clock, with a move counter, your best time, and a running average that will not let you pretend the last one did not happen. Solve it and the picture snaps whole, takes a bow, and the board deals you a new one. High scores are kept on the site, per photograph, so the person who beat your time is a real person with a real name. On a blog with over 4,000 posts that is over 4,000 unique puzzles, and nobody has finished them all. Arrow keys and WASD work. Reduced-motion visitors get a still field; older machines get fewer boards automatically. Yes, the mask is a Saw reference. Yes, you want to play a game.', 'GRAMOFSMACK (2.0)', 'Three-column grid over a live puzzle field / fifteen-puzzle modal'],
