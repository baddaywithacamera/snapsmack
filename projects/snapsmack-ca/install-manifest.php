...
// longform reading; photo and carousel modes use PHOTOGRAM. EVERY other
...
$mobile_skin = ($mode === 'smacktalk') ? 'telegram' : 'photogram';

$result = [];
foreach ($reg_skins as $slug => $s) {
    $is_required_mobile = ($slug === $mobile_skin) && !empty($s['features']['mobile_only']);
