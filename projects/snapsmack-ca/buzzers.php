    ...
    <section class="posts">
        <div class="wrap">
            ...
            <article class="post" id="a035">
                ...
                <p>The report is marked <strong>CODE REMEDIATED</strong>, not operationally finished. Historical poisoned rows still require a recoverable fleet cleanup, and ban lifetime, pruning, and owner-lockout alerting remain tracked work. That distinction is deliberate: the exploitable trust failure is closed, while database hygiene and lifecycle hardening stay visible until they are actually completed.</p>
