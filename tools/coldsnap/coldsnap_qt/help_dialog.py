...
TOPICS = [
    ...
    ("BIGGIE — the block editor",
     ...
     "Heading, Quote, Pullquote, List, Image, Columns, Spacer, Divider, Mosaic "
     ...
     "A Paragraph can make its first letter a drop cap. Columns contain their "
     "own blocks, support one to four columns and useful unequal-width presets; "
     "columns inside columns are deliberately unavailable. The face you used "
     "last is remembered. Desktop-only: BIGGIE never "
