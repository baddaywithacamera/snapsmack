...
TOPICS = [
    ...
    ("BIGGIE — the WYSIWYG editor",
     ...
     "grid of the site's Media Gallery pictures (what COLD STORAGE has synced); click one "
     "and it appears in the page. An image the cache doesn't have yet can still be typed "
     "as an id.\n\n"
