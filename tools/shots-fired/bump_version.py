...
the changelog's latest entry keeps matching BUILD_VERSION. Prints the new version.

Pure stdlib. Safe to run by hand; idempotent on the CHANGELOG (won't double-add).
Cloned from COLD SNAP's bump_version.py; only the MAIN filename differs.
"""
