...
**Product name:** **THE HUB** — the SnapSmack desktop front end and launcher.
...
### 4. Name
The product name is **THE HUB**. Install it at `C:\snapsmack\hub\hub.exe`.
SNAP SLAPPER is a separate photo manager that THE HUB detects and launches.
