...
TOPICS = [
    ...
    ("Masks",
     ...
     "Gradient tool starts at the edge and drags inward. Hide from edge paints "
     "black-to-transparent into the existing mask; Reveal from edge paints "
     "white-to-transparent. Repeated drags build one mask and each is undoable. "
     "The latest start-to-end guide remains visible while the tool is active. "
    ...
    ("Keyboard",
     ...
     "Layers: Ctrl+I invert colour · Ctrl+Shift+I invert luminance. "
