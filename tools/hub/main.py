"""
SNAP HQ Ã¢â‚¬â€ SnapSmack unified desktop front end & launcher.

One door: launch every offline tool from here, and set the fleet up ONCE. Enter the
hub login and hit Discover Fleet Ã¢â‚¬â€ it fills the SHARED stores (snap_creds + snap_profiles)
...
# wrong during HQ startup is recorded. Filed under HQ's own namespace Ã¢â‚¬â€ it used to
...
# Ã¢â€â‚¬Ã¢â€â‚¬ palette (matches the tool family: onyx + green) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
BG      = "#0a0a0a"
CARD    = "#141414"
INK     = "#e6e6e6"
DIM     = "#8a8a8a"
...
# Ã¢â€â‚¬Ã¢â€â‚¬ the tools SNAP HQ fronts, and where they install Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
# be a source of WILDCARD-matched launch targets Ã¢â‚¬â€ see _find_exe and SECAUDIT 044.
def _shared_root():
...
# one folder on any drive/letter Ã¢â‚¬â€ Sean's "all utils in one place" requirement. Each
...
def _find_exe(paths):
    ...
    resolves inside the shared root, because that tree is the GYSS write-jail Ã¢â‚¬â€ a
...
# Ã¢â€â‚¬Ã¢â€â‚¬ Roster-exe hash pinning (SECAUDIT 054) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
# The Hub launches exes that live inside the shared root Ã¢â‚¬â€ the same tree the
...
def _exe_pin_verify(path):
    ...
    try:
        with open(ledger_file, encoding="utf-8") as fh:
            ledger = json.load(fh)
    except Exception:  # noqa: BLE001 Ã¢â‚¬â€ absent/corrupt ledger = start fresh
        ledger = {}
...
def _launch(path, parent=None):
    try:
        ...
        if status == "changed":
            ...
            # either the operator's own rebuild Ã¢â‚¬â€ or exactly the swap the pin
            ...
            proceed = messagebox.askyesno(
                ...
                parent=parent)
            if not proceed:
                return False, "Launch cancelled Ã¢â‚¬â€ the exe changed and was not trusted."
...
class Hub(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title(f"SNAP HQ Ã¢â‚¬â€ local desktop headquarters   (build {BUILD_VERSION})")
    ...
    def _build_header(self):
        ...
        settings_b = tk.Button(h, text="Ã¢Å¡â„¢  SETTINGS", bg=ACCENT, fg=BG,
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ launcher Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ shared setup Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    def _field(self, parent, label, key, show=None, browse=False, test=None, reveal=False):
        ...
        if reveal and show:
            ...
            self._hoverize(rb)
        if browse:
            bb = tk.Button(line, text="Ã¢â‚¬Â¦", bg=FIELD, fg=INK, relief="flat",
    ...
    def _set_status(self, label, ok, msg):
        if label is not None:
            label.configure(text=("Ã¢Å“â€œ " if ok else "Ã¢Å“â€” ") + msg,
                            fg=ACCENT if ok else "#ff5555")

    def _testing(self, label):
        if label is not None:
            label.configure(text="testingÃ¢â‚¬Â¦", fg=DIM)
            self.update_idletasks()
    ...
    def _test_hub(self, status):
        ...
        try:
            ...
            n = len(spokes or [])
            self._set_status(status, True, f"connected Ã¢â‚¬â€ {n} site(s)")
        except Exception as e:
    ...
    def _test_drive(self, status):
        ...
        if not folder:
            self._set_status(status, True, "creds look valid Ã¢â‚¬â€ add a backup folder ID")
        else:
            self._set_status(status, True, "creds + folder set Ã¢â‚¬â€ SUYB proves the live link")
    ...
    def _build_setup(self, parent):
        auth = self._card(parent, "DEVICE AUTHORIZATION  Ã‚Â·  one CMS licence, up to four computers")
        ...
        for column, (label, variable, secret) in enumerate((
            ...
            entry = tk.Entry(cell, textvariable=variable, show="Ã¢â‚¬Â¢" if secret else "", bg=FIELD, fg=INK,
        ...
        card = self._card(parent, "HUB SETUP  Ã‚Â·  set once, every tool has it")
        self._field(card, "HUB SITE URL",   "hub_url")
        self._field(card, "HUB API KEY",    "hub_key", show="Ã¢â‚¬Â¢", test=self._test_hub)
        self._field(card, "CLAUDE API KEY", "claude_api_key", show="Ã¢â‚¬Â¢",
                    test=lambda s: self._test_ai_provider(s, "claude", "claude_api_key"))
        self._field(card, "GEMINI API KEY", "gemini_api_key", show="Ã¢â‚¬Â¢", test=self._test_gemini)
        self._field(card, "KIMI API KEY", "kimi_api_key", show="Ã¢â‚¬Â¢", reveal=True)
        self._field(card, "DEEPSEEK API KEY", "deepseek_api_key", show="Ã¢â‚¬Â¢", reveal=True)
        self._field(card, "CLAUDE API KEY", "claude_api_key", show="Ã¢â‚¬Â¢", reveal=True)
        self._field(card, "OPENAI API KEY", "openai_api_key", show="Ã¢â‚¬Â¢", reveal=True)
        self._field(card, "GOOGLE DRIVE CREDENTIALS (json)", "google_credentials", browse=True, test=self._test_drive)
        self._field(card, "BACKUP FOLDER ID", "drive_folder_id", show="Ã¢â‚¬Â¢", reveal=True)
        ...
        disc_b = tk.Button(bar, text="Ã¢Å¸Â³  DISCOVER FLEET", bg=ACCENT, fg=BG,
    ...
    def _show_device_auth_status(self, result=None):
        ...
        if status == "full":
            ...
            text, colour = f"Ã¢Å“â€œ AUTHORIZED Ã‚Â· renew by {expiry}", ACCENT
        elif status == "grace":
            expiry = datetime.fromtimestamp(int(payload.get("grace_ends_at", 0))).strftime("%Y-%m-%d")
            text, colour = f"! GRACE PERIOD Ã‚Â· connect by {expiry}", "#ffb000"
        else:
            text, colour = "RESTRICTED Ã‚Â· SNAP SLAPPER opens and exports only", "#ff5555"
    ...
    def _activate_device(self):
        ...
        self._device_status.configure(text="authorizingÃ¢â‚¬Â¦", fg=DIM)
        self.update_idletasks()
        try:
    ...
    def _refresh_device_auth(self):
        self._device_status.configure(text="checkingÃ¢â‚¬Â¦", fg=DIM); self.update_idletasks()
        try:
    ...
    def _on_save_creds(self):
        ...
        try:
            ...
            msg = f"Ã¢Å“â€œ {saved} credential(s) saved"
            if cleared:
                msg += f", {cleared} cleared"
            self._setup_status.configure(text=f"{msg} Ã‚Â· shared vault", fg=ACCENT)
        except Exception as e:
    ...
    def _on_discover(self):
        ...
        try:
            ...
            return
        self._setup_status.configure(text="saving + discoveringÃ¢â‚¬Â¦", fg=DIM)
        self.update_idletasks()
        try:
        ...
        if native_failed:
            self._setup_status.configure(
                text=f"saved {n} site(s), but {len(native_failed)} native app credential(s) failed Ã¢â‚¬â€ details shown",
                fg="#ff5555")
            messagebox.showerror(
                "Some app credentials were not saved",
                "Windows protected storage refused:\n\n" + "\n".join(
                    f"{row['site_url']} Ã¢â‚¬â€ {row['key_type']}" for row in native_failed),
                parent=self)
        else:
            self._setup_status.configure(text=f"Ã¢Å“â€œ saved + {n} site(s) into the shared store", fg=ACCENT)

    # Ã¢â€â‚¬Ã¢â€â‚¬ shared profiles list Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    def _build_profiles(self, parent):
        ...
        tk.Button(root_line, text="CHOOSE FOLDERÃ¢â‚¬Â¦", command=self._browse_workflow_root, bg=FIELD,
        ...
        tk.Label(root_row,
                 text="Example: Main folder  Ã¢â‚¬Âº  example.com  Ã¢â‚¬Âº  Upload / Finished",
        ...
        # here Ã¢â‚¬â€ two boxes whose values get overwritten are two dead controls).
        ...
        self._advanced_button = tk.Button(
            advanced, text="Ã¢â€“Â¸ Advanced image settings", bg=CARD, fg=DIM,
        ...
        for row, (label, key) in enumerate(fields, start=1):
            ...
            if key == "handoff_dir":
                tk.Button(self._advanced_frame, text="CHOOSEÃ¢â‚¬Â¦", command=self._browse_handoff, bg=FIELD, fg=INK,
    ...
    def _toggle_advanced(self):
        ...
        if self._advanced_visible:
            ...
            self._advanced_button.configure(text="Ã¢â€“Â¾ Advanced image settings")
        else:
    ...
    def _refresh_profiles(self):
        ...
        self._profile_choice_map = {}
        if not profs:
            self._prof_choice.set("No blogs found Ã¢â‚¬â€ use FIND MY BLOGS above")
    ...
    def _on_profile_selected(self, _event=None):
        ...
        for key, value in portable.items():
            ...
            # schema additions) Ã¢â‚¬â€ an unknown key must never crash the window.
        ...
        self._site_status.configure(text=("OFFLINE COPY Ã¢â‚¬â€ synced " + synced if synced else "NOT YET SYNCED"), fg=DIM)
    ...
    def _save_site_settings(self):
        ...
        try:
            ...
            try:
                ...
                self._site_status.configure(
                    text="Ã¢Å“â€œ Prompt and blog settings saved" + (" Ã¢â‚¬â€ " + states if states else ""),
                    fg=ACCENT)
                ...
                if "unknown action" not in str(sync_exc).lower():
                    raise
                self._site_status.configure(
                    text="Ã¢Å“â€œ Prompt saved to the blog; image settings saved on this computer",
                    fg=ACCENT)
        except Exception as exc:
    ...
    def _build_prompts(self, parent):
        card = self._card(parent, "PROMPT SYNC  Ã‚Â·  one AI prompt per blog, shared across the fleet")
        wrap = tk.Frame(card, bg=CARD)
        wrap.pack(fill="both", expand=True, padx=14, pady=(0, 12))
        ...
        pull_all = tk.Button(top, text="Ã¢Å¸Â³  PULL ALL FROM FLEET", bg=ACCENT, fg=BG,
        ...
        bot.pack(fill="x")
        copy_b = tk.Button(bot, text="COPY FROMÃ¢â‚¬Â¦", bg=FIELD, fg=INK, relief="flat",
                           cursor="hand2", font=("Segoe UI", 9), command=self._on_copy_from)
        copy_b.pack(side="left", ipadx=6, ipady=3)
        pull_one = tk.Button(bot, text="Ã¢Â¬â€¡  PULL THIS SITE", bg=FIELD, fg=INK, relief="flat",
                             cursor="hand2", font=("Segoe UI", 9), command=self._on_pull_one)
        pull_one.pack(side="left", padx=(8, 0), ipadx=6, ipady=3)
        push_b = tk.Button(bot, text="Ã¢Â¬â€   PUSH TO THIS SITE", bg=INK, fg=BG,
                           activebackground=ACCENT, activeforeground=BG, relief="flat",
    ...
    def _prompt_fetch(self, profile):
        ...
        if not key:
            raise RuntimeError("no GYSS key for this site Ã¢â‚¬â€ run Discover Fleet")
    ...
    def _on_pull_all(self):
        ...
        if not profs:
            ...
            return
        self._psync_status.configure(text="pulling from the fleetÃ¢â‚¬Â¦", fg=DIM)
        self.update_idletasks()
        try:
        ...
        msg = (f"Pulled {len(added) + len(unchanged)} blog(s) into the shared pool.\n\n"
               f"Ã¢â‚¬Â¢ {len(added)} new prompt(s) added\n"
               f"Ã¢â‚¬Â¢ {len(unchanged)} already matched\n")
        if differs:
            msg += ("Ã¢â‚¬Â¢ " + str(len(differs)) + " differ from your local pool (left untouched): "
                    + ", ".join(d["site"] for d in differs)
                    + "\n   Select one, then PULL THIS SITE to see the live copy, or PUSH to overwrite it.\n")
        if failed:
            msg += ("Ã¢â‚¬Â¢ " + str(len(failed)) + " could not be reached: "
                    + ", ".join(f'{f["site"]} ({f["error"]})' for f in failed) + "\n")
        self._psync_status.configure(
            text=f"Ã¢Å“â€œ {len(added)} added Ã‚Â· {len(differs)} differ Ã‚Â· {len(failed)} failed",
    ...
    def _on_pull_one(self):
        ...
        if not p:
            return
        self._psync_status.configure(text="fetching this site's live promptÃ¢â‚¬Â¦", fg=DIM)
        self.update_idletasks()
        try:
        ...
        self._psync_status.configure(text="Ã¢Å“â€œ showing the live prompt Ã¢â‚¬â€ PUSH to keep it, or edit first", fg=ACCENT)
    ...
    def _on_push_one(self):
        ...
        if not messagebox.askyesno(
                ...
                parent=self):
            return
        self._psync_status.configure(text="pushingÃ¢â‚¬Â¦", fg=DIM)
        self.update_idletasks()
        try:
            ...
            return
        if ok:
            self._psync_status.configure(text=f"Ã¢Å“â€œ pushed to {key} and saved to the shared pool", fg=ACCENT)
        else:
            self._psync_status.configure(
                text="push rejected Ã¢â‚¬â€ check the site key (re-run Discover Fleet)", fg="#ff5555")
    ...
    def _on_copy_from(self):
        ...
        if not others:
            ...
            return
        win = tk.Toplevel(self)
        win.title("Copy prompt fromÃ¢â‚¬Â¦")
        ...
        def _do():
            ...
            if sel:
                ...
                self._psync_status.configure(
                    text=f"copied {src}'s prompt into the editor Ã¢â‚¬â€ review, then PUSH", fg=ACCENT)
            win.destroy()
