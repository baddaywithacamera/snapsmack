...
python -m py_compile main.py flkrfckr_core.py flkrfckr_qt.py flkrfckr_launcher.py >> "_pycheck.out" 2>&1
echo PYEXIT=%errorlevel%>> "_pycheck.out"
echo === py -3 -m py_compile === >> "_pycheck.out" 2>&1
py -3 -m py_compile main.py flkrfckr_core.py flkrfckr_qt.py flkrfckr_launcher.py >> "_pycheck.out" 2>&1
