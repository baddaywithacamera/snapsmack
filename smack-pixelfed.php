...
if (isset($_GET['ajax'])) {
    ...
    if ($panel === 'home') {
        ...
        // Real reader: use the ingested inbound timeline. Never synchronously
        // fan out to remote servers during an interactive page request: one
        // unreachable peer used to hold Home behind stacked network timeouts.
