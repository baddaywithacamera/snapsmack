        ...
        <?php foreach ($desktop_devices as $device): ?>
            <div class="recent-item">
                ...
                <div class="item-actions" style="flex-wrap:wrap;">
                    <form method="post" action="smack-api-keys.php" class="form-inline"><input type="hidden" name="action" value="rename_device"><input type="hidden" name="device_id" value="<?php echo htmlspecialchars($device['id']); ?>"><input name="device_name" placeholder="Rename" class="device-rename-input"><button class="btn-reset">RENAME</button></form>
