...
ACTION LAB is included free for people running their own SnapSmack installation. It shares SNAP SLAPPER's entitlement rather than requiring a second key: if SNAP SLAPPER is unlocked, ACTION LAB is unlocked. The 90-day key, 14-day non-bonus grace period, renewal anchoring, expiry behavior, fork-renaming rule, and support boundary are defined in `desktop-tool-entitlements.md`.
