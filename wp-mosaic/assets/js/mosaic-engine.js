/**
 * WP Mosaic — Layout Engine
 *
 * Renders inline image mosaics from [mosaic id="X"] shortcodes.
 ...
 *
 * Originally built as ss-engine-mosaic.js for SnapSmack.
 */
...
(function () {
     ...
     * @returns {Array} rows          Each row is an array of image objects with render dims
     */
    function computeLayout(images, containerWidth, gap) {
        ...
        // Remaining images that didn't fill a complete row
        if (currentRow.length > 0) {
            ...
            // Single image in last row — cap width at 60%
    ...
    function initMosaics() {
        var containers = document.querySelectorAll('.wp-mosaic[data-mosaic]');
