...
- **SCROLL 0.1.24: divider aligned to the landing image row, solo page matches 50-Shades, hero spacing + serif body controls.** One version, everything since 0.1.23:
