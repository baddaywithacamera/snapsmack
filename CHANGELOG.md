...
- **SCROLL 0.1.26: divider aligned to the landing image row, solo page matches 50-Shades, hero spacing + serif body controls, landing filter modal.** Forward version after the deployed 0.1.25 (an earlier backward renumber attempt is abandoned — versions only move forward). Everything since 0.1.23:
