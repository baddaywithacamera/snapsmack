...
**Built by [Sean McCormick](https://github.com/baddaywithacamera), [Claude](https://www.anthropic.com/claude), and [OpenAI Codex](https://openai.com/codex/) — a photographer and AI co-authors, in genuine partnership.** This isn't autocomplete bolted onto a side project; it's real co-authorship. The [SMACK PUBLIC LICENSE](#license--the-smack-public-license-spl-22) exists in part to keep that credit permanent, not decorative.
