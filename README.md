...
**Built by [Sean McCormick](https://github.com/baddaywithacamera), [Claude](https://www.anthropic.com/claude), and [OpenAI Codex](https://openai.com/codex/) — a photographer and AI co-authors, in genuine partnership.** This isn't autocomplete bolted onto a side project; it's real co-authorship. The [SMACK PUBLIC LICENSE](#license--the-smack-public-license-spl-24) exists in part to keep that credit permanent, not decorative.
...
## License — the SMACK PUBLIC LICENSE (SPL) 2.4

SNAPSMACK is public and free to read, run, and self-host. It's licensed under the **SMACK PUBLIC LICENSE 2.4**, together with **THE THOMAS CLAUSE** — deliberately *not* the GPL.
