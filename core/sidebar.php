...
$_section_map = [
    ...
    'fediverse'  => ['smack-pixelfed.php','smack-dms.php','smack-fediverse-portal.php','smack-relay-status.php','smack-sv-followers.php','smack-sv-tools.php','smack-photochallenge.php'],
