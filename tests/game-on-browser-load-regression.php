...
gl_check('feed is paged on the server (one batch per request)', strpos($php, "\$_feed_per   = 120;") !== false
    && strpos($php, 'id="go-sentinel" class="ss-feed-sentinel" data-feed') !== false && strpos($php, '_go_emitted') === false);
