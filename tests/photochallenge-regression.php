...
pc_test(str_contains($admin, 'name="pc_drop_at" id="pc_drop_at" value="<?php echo $esc($def_drop_value); ?>"')
    && str_contains($prompt_js, "dropEl.value = promptDate + 'T' + promptTime"),
...
pc_test(str_contains($admin, '1. BOOSTING WINDOW STARTS AT')
    ...
    && str_contains($admin, 'DATES &mdash; THESE CONTROL DIFFERENT THINGS')
