...
fb_expect(str_contains($constants, "SNAPSMACK_VERSION_SHORT', '0.7.580'"), 'release must be version 0.7.580');
fb_expect(str_contains($constants, "SNAPSMACK_VERSION_CODENAME', 'FIRM FOOTING'"), 'release codename must be FIRM FOOTING');
