...
fb_expect(str_contains($constants, "SNAPSMACK_VERSION_SHORT', '0.7.583'"), 'release must be version 0.7.583');
fb_expect(str_contains($constants, "SNAPSMACK_VERSION_CODENAME', 'SQUARED AWAY'"), 'release codename must be SQUARED AWAY');
